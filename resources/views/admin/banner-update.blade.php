  ...
  <div class="box">
    <div class="box-body">
      <div style="width: 50%" class="tab-pane" id="settings">
        <form method="POST" action="/admin/banner/update" class="form-horizontal" enctype="multipart/form-data">
          {!! csrf_field() !!}
          ...
          @endif
            ...
            <div class="col-sm-8">
              <input name="title" value="{{ $banner->title }}" type="text" class="form-control" placeholder="请输入标题" />
          ...
          @endif
            ...
            <div class="col-sm-8">
              <input name="link" type="text" value="{{ $banner->link }}" class="form-control" placeholder="请输入链接" />
              <span class="help-block">
                @if (session('linkMessage'))
                  {{ session('linkMessage') }}
                @endif
